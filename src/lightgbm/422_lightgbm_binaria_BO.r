...
hs <- makeParamSet(
  ...
  makeNumericParam("min_gain_to_split", lower = 0.0, upper = 10.0),        # Ganancia mínima para split
  makeNumericParam("bagging_fraction", lower = 0.2, upper = 1.0),         # Fracción de muestreo para bagging
  makeNumericParam("cat_smooth", lower = 1.0, upper = 100.0)         # Suavizado para características categóricas
)
